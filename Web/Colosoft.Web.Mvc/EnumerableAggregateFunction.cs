...
{
	/// <summary>
	/// Representa o enumerable de função de agragação.
	/// </summary>
	public abstract class EnumerableAggregateFunction : Infrastructure.Implementation.EnumerableAggregateFunctionBase
	{
		/// <summary>
		/// Construtor padrão.
		/// </summary>
		...
		{
			return new Infrastructure.Implementation.Expressions.EnumerableAggregateFunctionExpressionBuilder(enumerableExpression, this) {
				Options =  {
