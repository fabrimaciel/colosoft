...
{
	internal sealed class Int32ArraySerializationSurrogate : ContextSensitiveSerializationSurrogate
	{
		public Int32ArraySerializationSurrogate() : base(typeof(int[]))
		{
		}
