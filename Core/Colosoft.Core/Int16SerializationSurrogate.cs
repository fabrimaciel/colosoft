...
{
	/// <summary>
	/// Implementação do substituto de serialização para <see cref="Int16"/>.
	/// </summary>
	internal sealed class Int16SerializationSurrogate : SerializationSurrogate
	{
		public Int16SerializationSurrogate() : base(typeof(short))
		{
		}
