...
{
	internal sealed class SingleArraySerializationSurrogate : ContextSensitiveSerializationSurrogate
	{
		public SingleArraySerializationSurrogate() : base(typeof(float[]))
		{
		}
