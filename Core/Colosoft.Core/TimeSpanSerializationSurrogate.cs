...
{
	/// <summary>
	/// Implementação do substituto de serialização para <see cref="TimeSpan"/>.
	/// </summary>
	internal sealed class TimeSpanSerializationSurrogate : SerializationSurrogate
	{
		public TimeSpanSerializationSurrogate() : base(typeof(TimeSpan))
		{
		}
