...
{
	/// <summary>
	/// Implementação do substituto de serialização para <see cref="DateTimeOffset"/>.
	/// </summary>
	internal sealed class DateTimeOffsetSerializationSurrogate : SerializationSurrogate
	{
		public DateTimeOffsetSerializationSurrogate() : base(typeof(DateTimeOffset))
		{
		}
		...
		{
			writer.Write((DateTimeOffset)graph);
		}
	}
}
