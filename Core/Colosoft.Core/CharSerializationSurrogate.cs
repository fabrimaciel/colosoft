...
{
	/// <summary>
	/// Implementação do substituto de serialização de um <see cref="char"/>
	/// </summary>
	internal sealed class CharSerializationSurrogate : SerializationSurrogate
	{
