...
{
	internal sealed class UInt64ArraySerializationSurrogate : ContextSensitiveSerializationSurrogate
	{
		public UInt64ArraySerializationSurrogate() : base(typeof(ulong[]))
		{
		}

		public override object Instantiate(CompactBinaryReader reader)
		{
			return new ulong[reader.ReadInt32()];
		}

		public override object ReadDirect(CompactBinaryReader reader, object graph)
		{
			ulong[] numArray = (ulong[])graph;
