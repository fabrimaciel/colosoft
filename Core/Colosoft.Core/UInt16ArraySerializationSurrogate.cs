...
{
	internal sealed class UInt16ArraySerializationSurrogate : ContextSensitiveSerializationSurrogate
	{
		public UInt16ArraySerializationSurrogate() : base(typeof(ushort[]))
		{
		}
