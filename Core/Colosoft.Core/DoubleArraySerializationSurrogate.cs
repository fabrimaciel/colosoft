...
{
	/// <summary>
	/// Implementação do substituto de serialização do vetor de <see cref="double"/>.
	/// </summary>
	internal sealed class DoubleArraySerializationSurrogate : ContextSensitiveSerializationSurrogate
	{
