...
{
	/// <summary>
	/// Implementação do predicado da comparação menor.
	/// </summary>
	public class FunctorLesserFunctorPredicate : Predicate, IComparable
	{
		...
		public FunctorLesserFunctorPredicate(IFunctor functor, IFunctor functor2)
		{
			_functor = functor;
			_functor2 = functor2;
		}
		...
		public int CompareTo(object obj)
		{
			...
			{
				FunctorLesserFunctorPredicate predicate = (FunctorLesserFunctorPredicate)obj;
