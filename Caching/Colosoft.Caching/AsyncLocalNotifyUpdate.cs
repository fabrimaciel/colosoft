...
namespace Colosoft.Caching
{
	...
	{
		private class AsyncLocalNotifyUpdate : IAsyncTask
		{
			private object _key;
			...
			public AsyncLocalNotifyUpdate(ICacheEventsListener listener, object key, OperationContext operationContext)
			{
				_listener = listener;
				_key = key;
