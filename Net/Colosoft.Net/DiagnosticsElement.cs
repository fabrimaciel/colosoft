...
namespace Colosoft.Net.Diagnostics
{
	...
	/// configurar o diagnostico para os serviços.
	/// </summary>
	public class DiagnosticsElement : BehaviorExtensionElement
	{
		/// <summary>
		...
		public override Type BehaviorType
		{
			get
			{
				return typeof(DiagnosticsBehavior);
			}
		}
		...
		{
			return new DiagnosticsBehavior();
		}
	}
}
