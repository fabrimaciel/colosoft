...
namespace Colosoft.Excel.ExcelXml
{
	...
	public class FontOptions : IFontOptions
	{
		...
		{
			return (Name == other.Name && Size == other.Size && Bold == other.Bold && Underline == other.Underline && Italic == other.Italic && Strikeout == other.Strikeout && Color == other.Color);
		}
	...
	public class InteriorOptions : IInteriorOptions
	{
		...
		{
			return (Color == other.Color && PatternColor == other.PatternColor && Pattern == other.Pattern);
		}
	...
	public class AlignmentOptions : IAlignmentOptions
	{
		...
		{
			return (Vertical == other.Vertical && Horizontal == other.Horizontal && Indent == other.Indent && Rotate == other.Rotate && WrapText == other.WrapText && ShrinkToFit == other.ShrinkToFit);
		}
	...
	public class BorderOptions : IBorderOptions
	{
		...
		{
			return (Sides == other.Sides && LineStyle == other.LineStyle && Weight == other.Weight && Color == other.Color);
		}
	...
	public class XmlStyle : IStyle
	{
		...
		{
			int r;
			if(Int32.TryParse(str.Substring(1, 2), NumberStyles.HexNumber, CultureInfo.InvariantCulture, out r))
			{
				int g;
				if(Int32.TryParse(str.Substring(3, 2), NumberStyles.HexNumber, CultureInfo.InvariantCulture, out g))
				{
					int b;
					if(Int32.TryParse(str.Substring(5, 2), NumberStyles.HexNumber, CultureInfo.InvariantCulture, out b))
					{
