...
namespace Colosoft.Excel.ExcelXml
{
	...
	public partial class Worksheet : Styles, IEnumerable<Cell>
	{
		...
		/// ranges, use <see cref="Colosoft.Excel.ExcelXml.Range.Name"/> property in
		/// <see cref="Colosoft.Excel.ExcelXml.Range"/>.</remarks>
		...
		/// <param name="rowIndex">Index of the <see cref="Colosoft.Excel.ExcelXml.Row"/> starting from 0</param>
		...
		/// </summary>
		/// <param name="rowIndex">Index of the <see cref="Colosoft.Excel.ExcelXml.Row"/> starting from 0</param>
		/// <returns><see cref="Colosoft.Excel.ExcelXml.Row"/> reference to the requested row</returns>
		...
		/// </summary>
		/// <param name="colIndex">Index of the <see cref="Colosoft.Excel.ExcelXml.Column"/> starting from 0</param>
		/// <returns><see cref="Colosoft.Excel.ExcelXml.Column"/> reference to the requested column</returns>
