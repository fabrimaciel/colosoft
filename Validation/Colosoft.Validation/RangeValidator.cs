...
namespace Colosoft.Validation.Validators
{
	...
	/// </summary>
	public class RangeValidator : Colosoft.Validation.IValidator, IEquatable<IValidator>
	{
		private Colosoft.Validation.IRange _test;

		/// <summary>
		/// Dados de verificação.
		/// </summary>
		public Colosoft.Validation.IRange Test
		{
			get
			{
				return _test;
		...
		public RangeValidator(Colosoft.Validation.IRange rangeValue)
		{
			_test = rangeValue;
		}
		...
		{
			var asSame = other as RangeValidator;
			return (asSame != null) && _test.GetType().Equals(asSame._test.GetType()) && String.Equals(_test.FromValue, asSame._test.FromValue) && String.Equals(_test.ToValue, asSame._test.ToValue);
		}
	}
}
