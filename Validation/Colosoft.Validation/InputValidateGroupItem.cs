...
{
	/// <summary>
	/// Item do grupo de validações de entrada.
	/// </summary>
	public class InputValidateGroupItem : NotificationObject, System.Xml.Serialization.IXmlSerializable
	{
		...
		{
			InputValidateUid = Guid.Parse(reader.GetAttribute("uid"));
			reader.Skip();
		}
		...
		{
			writer.WriteAttributeString("uid", InputValidateUid.ToString());
		}
	}
}
