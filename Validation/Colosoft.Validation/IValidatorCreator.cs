...
namespace Colosoft.Validation
{
	...
	public interface IValidatorCreator
	{
		...
		IValidator CreateValidator(IEnumerable<ParameterValue> parameters, System.Globalization.CultureInfo cultureInfo, ValidationResultType resultType = ValidationResultType.Error);
	}
}
