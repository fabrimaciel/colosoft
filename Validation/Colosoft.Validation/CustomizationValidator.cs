...
namespace Colosoft.Validation.Validators
{
	...
	/// </summary>
	public class CustomizationValidator : Colosoft.Validation.IValidator, IEquatable<IValidator>
	{
		private Colosoft.Validation.IInputValidateCustomization _test;

		/// <summary>
		/// Dados de verificação.
		/// </summary>
		public Colosoft.Validation.IInputValidateCustomization Test
		{
			get
			{
				return _test;
		...
		public CustomizationValidator(Colosoft.Validation.IInputValidateCustomization customizationValue)
		{
			_test = customizationValue;
		}
		...
		{
			var asSame = other as CustomizationValidator;
			return (asSame != null) && _test.GetType().Equals(asSame._test.GetType()) && _test.CheckMethod.GetType().Equals(asSame._test.CheckMethod.GetType());
		}
	}
}
