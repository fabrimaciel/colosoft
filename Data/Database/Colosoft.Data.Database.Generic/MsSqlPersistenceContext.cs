...
{
	/// <summary>
	/// Implementação do contexto de persitencia para o SqlServer.
	/// </summary>
	public class MsSqlPersistenceContext : IPersistenceContext
	{
		...
		public MsSqlPersistenceContext(Microsoft.Practices.ServiceLocation.IServiceLocator serviceLocator, Schema.ITypeSchema typeSchema)
		{
		...
		{
			return new MsSqlPersistenceExecuter(_serviceLocator, _typeSchema);
		}
