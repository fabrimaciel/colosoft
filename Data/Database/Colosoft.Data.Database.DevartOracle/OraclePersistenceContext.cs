...
{
	/// <summary>
	/// Implementação do contexto de persistencia do Oracle.
	/// </summary>
	public class OraclePersistenceContext : IPersistenceContext
	{
		...
		public OraclePersistenceContext(Microsoft.Practices.ServiceLocation.IServiceLocator serviceLocator, Schema.ITypeSchema typeSchema)
		{
		...
		{
			return new OracleGenericPersistenceExecuter(_serviceLocator, _typeSchema);
		}
