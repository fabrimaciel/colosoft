...
namespace Colosoft.Query
{
	...
	/// </summary>
	public class DynamicBindStrategy : IQueryResultBindStrategy
	{
		private Func<IEnumerable<IRecord>, BindStrategyMode, System.Collections.IEnumerable> _func;

		/// <summary>
		/// Construtor padrão.
		/// </summary>
		/// <param name="func">Ponteiro do método que será usado na vinculação.</param>
		public DynamicBindStrategy(Func<IEnumerable<IRecord>, BindStrategyMode, System.Collections.IEnumerable> func)
		{
