...
{
	/// <summary>
	/// Implementação da interface para recuperação da data do servidor para
	/// o Microsoft SQL Server.
	/// </summary>
	public class MsSqlServerData : Colosoft.IServerData
	{
			...
			get
			{
				if(!IsValid)
				{
					try
					{
						...
						{
							var date = new GDA.DataAccess().ExecuteScalar(session, "SELECT GETDATE()");
							if(date is DateTime)
							{
