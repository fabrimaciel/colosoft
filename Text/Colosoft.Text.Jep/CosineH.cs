...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class CosineH : PostfixMathCommand
	{
		public CosineH()
		{
		...
		public object CoshOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(Math.Cosh(((JepDouble)param).DoubleValue));
		}
		...
		public override void Run(Stack<object> inStack)
		{
			...
			inStack.Push(this.CoshOp(param));
		}
	}
}
