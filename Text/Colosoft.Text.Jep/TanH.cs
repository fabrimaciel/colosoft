...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class TanH : PostfixMathCommand
	{
		public TanH()
		{
		...
		public override void Run(Stack<object> inStack)
		{
			...
			inStack.Push(this.TanhOp(param));
		}

		public object TanhOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(Math.Tanh(((JepDouble)param).DoubleValue));
		}
	}
}
