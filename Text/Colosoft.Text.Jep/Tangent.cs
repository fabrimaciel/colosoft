...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class Tangent : PostfixMathCommand
	{
		public Tangent()
		{
		...
		public override void Run(Stack<object> inStack)
		{
			...
			inStack.Push(this.TanOp(param));
		}

		public object TanOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(Math.Tan(((JepDouble)param).DoubleValue));
		}
	}
}
