...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class Cosine : PostfixMathCommand, IRealUnaryFunction
	{
		public Cosine()
		{
		...
		public object CosOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(Math.Cos(((JepDouble)param).DoubleValue));
		}
