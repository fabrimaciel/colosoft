...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class UMinus : PostfixMathCommand, IRealUnaryFunction
	{
		public UMinus()
		{
		...
		public override void Run(Stack<object> inStack)
		{
			...
			inStack.Push(this.UminOp(param));
		}

		public object UminOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(-((JepDouble)param).DoubleValue);
		}
	}
}
