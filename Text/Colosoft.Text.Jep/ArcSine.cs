...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class ArcSine : PostfixMathCommand, IRealUnaryFunction
	{
		public ArcSine()
		{
		...
		public object AsinOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(Math.Asin(((JepDouble)param).DoubleValue));
		}
		...
		public override void Run(Stack<object> inStack)
		{
			...
			inStack.Push(this.AsinOp(param));
		}
	}
}
