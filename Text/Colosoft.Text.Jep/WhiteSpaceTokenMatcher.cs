...
namespace Colosoft.Text.Jep.ConfigurableParser.Matchers
{
	...
	public class WhiteSpaceTokenMatcher : RegExpTokenMatcher
	{
		public WhiteSpaceTokenMatcher(string regex) : base(regex)
		{
		}

		public WhiteSpaceTokenMatcher(Regex pattern) : base(pattern)
		{
		}
		...
		{
			return new WhiteSpaceTokenMatcher(@"\s+");
		}
