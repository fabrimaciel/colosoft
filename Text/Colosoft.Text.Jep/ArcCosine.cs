...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class ArcCosine : PostfixMathCommand, IRealUnaryFunction
	{
		public ArcCosine()
		{
		...
		public object AcosOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(Math.Acos(((JepDouble)param).DoubleValue));
		}
		...
		public override void Run(Stack<object> inStack)
		{
			...
			inStack.Push(this.AcosOp(param));
		}
	}
}
