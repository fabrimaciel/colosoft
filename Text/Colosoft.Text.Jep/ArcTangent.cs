...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class ArcTangent : PostfixMathCommand, IRealUnaryFunction
	{
		public ArcTangent()
		{
		...
		public object AtanOp(object param)
		{
			if(param is Complex)
			{
			...
			return new JepDouble(Math.Atan(((JepDouble)param).DoubleValue));
		}
		...
		public override void Run(Stack<object> inStack)
		{
			...
			inStack.Push(this.AtanOp(param));
		}
	}
}
