...
namespace Colosoft.Text.Jep.Functions
{
	...
	public class Modulus : PostfixMathCommand
	{
		public Modulus()
		{
		...
		public override void Run(Stack<object> inStack)
		{
			...
			double doubleValue = ((JepDouble)obj2).DoubleValue;
			double input = ((JepDouble)obj3).DoubleValue % doubleValue;
			inStack.Push(new JepDouble(input));
		}
	}
}
