...
namespace Colosoft.Business
{
	...
	public class SaveResult : IXmlSerializable
	{
		/// <summary>
		...
		public SaveResult(bool success, IMessageFormattable message)
		{
		...
		public static implicit operator bool(SaveResult value)
		{
			if(value == null)
				return false;
		...
		public static System.Xml.XmlQualifiedName GetMySchema(System.Xml.Schema.XmlSchemaSet xs)
		{
			...
			return new System.Xml.XmlQualifiedName("SaveResult", BusinessNamespace.Data);
		}
