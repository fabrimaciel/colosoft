...
namespace Colosoft.Business
{
	...
	{
		private Type _entityLoaderType;

		/// <summary>
		/// Tipo do loader da entidade.
		/// </summary>
		public Type EntityLoaderType
		{
			get
			{
				return _entityLoaderType;
			}
		}
		...
		public EntityLoaderAttribute(Type entityLoaderType)
		{
			_entityLoaderType = entityLoaderType;
		}
	}
}
